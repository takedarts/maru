...
set( CYTHON_LIBRARIES ${Python3_LIBRARIES} )
...
function( cython_add_module _name )
  ...
  target_link_libraries( ${_name} PRIVATE ${CYTHON_LIBRARIES} )
endfunction()
...
function( cython_add_standalone_executable _name )
  ...
  target_link_libraries( ${_name} ${CYTHON_LIBRARIES} ${pyx_module_libs} )
endfunction()
